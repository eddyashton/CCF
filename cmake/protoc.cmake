...
function(add_protobufs)
  file(GLOB PROTO_FILES CONFIFURE_DEPENDS *.proto)
  message(STATUS "PROTO_FILES is: ${PROTO_FILES}")
  ...
  foreach(proto_file ${PROTO_FILES})
    ...
    add_custom_command(
      OUTPUT ${CMAKE_BINARY_DIR}/generated/${PROTO_NAME_WE}.pb.h
            ${CMAKE_BINARY_DIR}/generated/${PROTO_NAME_WE}.pb.cc
      COMMAND ${PROTOC_BINARY_PATH} --proto_path=${CMAKE_CURRENT_SOURCE_DIR}
              --cpp_out=${CMAKE_BINARY_DIR}/generated ${proto_file}
      COMMENT "Generate C++ source files from protobuf file ${PROTO_NAME}"
      DEPENDS ${proto_file}
    )
    add_custom_target(
      ${PROTO_NAME_WE}_proto_cpp ALL
      DEPENDS ${CMAKE_BINARY_DIR}/generated/${PROTO_NAME_WE}.pb.h
              ${CMAKE_BINARY_DIR}/generated/${PROTO_NAME_WE}.pb.cc
    )

    add_custom_command(
      OUTPUT
        ${CMAKE_SOURCE_DIR}/tests/${PROTO_NAME_WE}_pb2.py
        ${CMAKE_SOURCE_DIR}/tests/${PROTO_NAME_WE}_pb2_grpc.py
      COMMAND ${CMAKE_SOURCE_DIR}/scripts/build-protobuf.sh ${proto_file}
