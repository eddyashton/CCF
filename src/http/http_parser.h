...
namespace http
{
  ...
  // Defined out-of-line in http_parser.cpp so that the (expensive to compile)
  // std::regex machinery is only instantiated once, rather than in every
